...
import com.cwy.entity.Blog;
import com.cwy.entity.PageBean;
import com.cwy.service.BlogService;
import com.cwy.util.PageUtil;
import com.cwy.util.StringUtil;
...
public class IndexController {
	...
	public ModelAndView download()throws Exception{
		...
		mav.addObject("pageTitle","陈文源博客系统");
		mav.setViewName("mainTemp");
		return mav;
	}
}
